...
// PrecompiledContractsHomestead contains the default set of pre-compiled Sagecity
...
// PrecompiledContractsByzantium contains the default set of pre-compiled Sagecity
