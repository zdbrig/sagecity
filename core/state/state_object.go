...
// stateObject represents an Sagecity account which is being modified.
//
...
type stateObject struct {
	...
	addrHash common.Hash // hash of sagecity address of the account
	data     Account
	db       *StateDB
...
// Account is the Sagecity consensus representation of accounts.
