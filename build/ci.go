...
import (
	...
	"github.com/zdbrig/sagecity/internal/build"
)
...
var (
	...
	debExecutables = []debExecutable{
		{
			Name:        "abigen",
			Description: "Source code generator to convert Sagecity contract definitions into easy to use, compile-time type-safe Go packages.",
		},
		{
			Name:        "bootnode",
			Description: "Sagecity bootnode.",
		},
		{
			Name:        "evm",
			Description: "Developer utility version of the EVM (Sagecity Virtual Machine) that is capable of running bytecode snippets within a configurable environment and execution mode.",
		},
		{
			Name:        "geth",
			Description: "Sagecity CLI client.",
		},
		{
			Name:        "puppeth",
			Description: "Sagecity private network manager.",
		},
		{
			Name:        "rlpdump",
		...
		{
			Name:        "swarm",
			Description: "Sagecity Swarm daemon and tools",
		},
		{
			Name:        "wnode",
			Description: "Sagecity Whisper diagnostic tool",
		},
	}
...
func doDebianSource(cmdline []string) {
	var (
		...
		upload  = flag.String("upload", "", `Where to upload the source package (usually "ppa:sagecity/sagecity")`)
...
type debMetadata struct {
	...
	// sagecity version being built. Note that this
...
func newDebMetadata(distro, author string, env build.Environment, t time.Time) debMetadata {
	if author == "" {
		...
		author = "Sagecity Builds <fjl@sagecity.org>"
	}
	return debMetadata{
		Env:         env,
		Author:      author,
...
func doAndroidArchive(cmdline []string) {
	...
	build.MustRun(gomobileTool("bind", "--target", "android", "--javapkg", "org.sagecity", "-v", "github.com/zdbrig/sagecity/mobile"))
...
func doXCodeFramework(cmdline []string) {
	...
	bind := gomobileTool("bind", "--target", "ios", "--tags", "ios", "-v", "github.com/zdbrig/sagecity/mobile")
